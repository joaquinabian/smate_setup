...
function set_connection() {
    echo "Setting connection $1 for Raspi $RPITYPE"
    #
...
#
echo "TP-Link Static IPs are assigned in the Router"
echo "Maybe this should be changed as for Home Wifi (To assign them on Network Manager)" 
#
#IP4=""
#GW4=""
#DN4=""
